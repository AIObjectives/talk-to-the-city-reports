...
export default class FilterCSVNode {
	...
	async compute(
		...
		let outArray = _.head(_.values(inputData)) || [];
...
export let filter_csv_node_data: FilterCSVNodeInterface = {
	id: 'filter_csv',
	data: {
		label: 'filter_csv',
		output: {},
...
export let filter_csv_node = new FilterCSVNode(filter_csv_node_data);
