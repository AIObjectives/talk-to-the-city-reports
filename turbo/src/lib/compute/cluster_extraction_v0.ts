...
export let cluster_extraction_node_data_v0: ClusterExtractionNodeInterface = {
...
export let cluster_extraction_node_v0 = new ClusterExtractionNode(cluster_extraction_node_data_v0);
