...
export let multi_cluster_extraction_node_data: MultiClusterExtractionNodeInterface = {
...
export let multi_cluster_extraction_node = new MultiClusterExtractionNode(
