Multi Cluster Extraction extracts topics and subtopics from the given text. The `context limit` setting represents how many tokens are analyzed at a time (there are roughly 1.5 tokens per word).
