...
|---|---|---:|
| *extract the given arguments* | **passed** | `35` |
...
| Test | Status | Duration (ms) |
|---|---|---:|
| *should correctly count tokens in input data* | **passed** | `270` |
...
| Test | Status | Duration (ms) |
|---|---|---:|
| *should process data correctly with JQ filter* | **passed** | `188` |
...
| *catches errors when evaluating expressions* | **passed** | `4` |
...
| *does not merge if cluster_extraction data has no topics* | **passed** | `1` |
...
| Test | Status | Duration (ms) |
|---|---|---:|
| *should set the key in cookies if the UI key is valid* | **passed** | `10` |
...
| Test | Status | Duration (ms) |
|---|---|---:|
| *scores the relevance of arguments* | **passed** | `117` |
| *uses cached data if available and not dirty* | **passed** | `0` |
