...
| Test | Status | Duration (ms) |
|---|---|---:|
| *extract the cluster* | **passed** | `134` |
...
| *returns undefined if input is undefined* | **passed** | `1` |
...
| Test | Status | Duration (ms) |
|---|---|---:|
| *should process data correctly with JQ filter* | **passed** | `179` |
...
| *should not set markdown data if input is an object* | **passed** | `1` |
...
| Test | Status | Duration (ms) |
|---|---|---:|
| *merges cluster extraction data* | **passed** | `129` |
| *does not merge if cluster extractions are missing* | **passed** | `118` |
...
| Test | Status | Duration (ms) |
|---|---|---:|
| *test node registeration* | **passed** | `10` |
...
| Test | Status | Duration (ms) |
|---|---|---:|
| *scores the relevance of arguments* | **passed** | `129` |
| *uses cached data if available and not dirty* | **passed** | `1` |
